package com.urcib.speedvts.widgets;
...
//				onLoadMore();
                ...
                if (haveInternet(context)) {
                    ...
                    if (count == 0) {
                        Toast.makeText(context, "Could not connect top internet.", Toast.LENGTH_SHORT).show();
                        count++;
                    }
                }
            }
    ...
    public boolean haveInternet(Context thisActivity) {
